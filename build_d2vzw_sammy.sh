...
export PACKAGEDIR=$PARENT_DIR/Packages/TW_KK_VZW
#Enable FIPS mode
...
make KT747_defconfig VARIANT_DEFCONFIG=msm8960_m2_vzw_defconfig
...
if [ -e $KERNELDIR/arch/arm/boot/zImage ]; then
	...
	rm ramdisk.gz
	rm zImage
	rm ../KT747-TW-KK-4.4-VZW*.zip
	zip -r ../KT747-TW-KK-4.4-VZW-$curdate.zip .
	cd $KERNELDIR
else
